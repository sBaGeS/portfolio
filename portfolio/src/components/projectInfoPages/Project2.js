...
export default function Project2() {
        ...
        return (
            ...
            <div className="project_box">
             ...
             miltä tahansa nettisivulta eli webscrapeemiseen ja tässä tapauksessa myös sivulla olevien nappuloiden painamiseen. Electronin avulla tein tästä botista ajattevan .exe windows sovelluksen.
            <br/><br/>
